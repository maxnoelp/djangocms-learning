"""
Django settings for depiLandingpage project.
...
SECRET_KEY = 'django-insecure-ul43l#zj$$31l2z(c39ane(s!d@40*!!vj8)!zqozjhza!gwl_'
...
ROOT_URLCONF = 'depiLandingpage.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [
            os.path.join(BASE_DIR, "depiLandingpage", "templates"),
        ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'depiLandingpage.wsgi.application'
...
STATICFILES_DIRS = [
    BASE_DIR / "depiLandingpage" / "static",
]
